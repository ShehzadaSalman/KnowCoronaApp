          ...
          child: Padding(
            ...
            child: Column(children: <Widget>[
              ...
              Wrap(
                ...
                children: <Widget>[
                  coronaBadges(
                      'Images/Group-2.png', testVariable, '/survey', context),
                  coronaBadges('Images/Group-91.png', testVariablefive,
                      '/washing', context),
                  coronaBadges('Images/Group-93.png', testVariablefour,
                      '/tissue', context),
                  coronaBadges('Images/Group-90.png', testVariabletwo,
                      '/hydration', context),
                  coronaBadges('Images/Group-1.png', testVariablethree,
                      '/sneeze', context),
                ],
              ),
              SizedBox(height: 35),
                        ...
                        child: RichText(
                          ...
                          text: TextSpan(
                              ...
                              children: [
                                TextSpan(
                                    text:
                                        context.getString('Survivor.t6') + '\n',
                                    style: TextStyle(
                                      color: Color(0xFF9B51E0),
                                      fontWeight: FontWeight.bold,
                                    )),
                                TextSpan(text: context.getString('Survivor.t7'))
                              ]),
                        ),
                      ),
                    ),
...
//  }
  ...
  void initializeSharedPreferences() async {
    ...
    allSectionsCompleted
        .add(sharedPreferences.getBool('stayHydratedCompleted'));
    allSectionsCompleted
        .add(sharedPreferences.getBool('sneezeSectionCompleted'));
    allSectionsCompleted
        .add(sharedPreferences.getBool('socialDistanceCompleted'));
    allSectionsCompleted
        .add(sharedPreferences.getBool('tissueHandlingCompleted'));
    allSectionsCompleted
        .add(sharedPreferences.getBool('washingHandsCompleted'));
...
Widget coronaBadges(String imgAddress, bool borderColor, String routeName,
  ...
  return InkWell(
    ...
    child: Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [
          BoxShadow(
              color: borderColor ? Color(0xFF6FCF97) : Color(0xFFE3E6EC),
              spreadRadius: 3),
        ],
      ),
    ),
