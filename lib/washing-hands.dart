...
class _WashingHandsState extends State<WashingHands> {
  String apiURL = "https://knowcorona19.com/api/urduquizwash";
...
//                                       children: quizHelper.results[index].incorrectAnswers.map((f){
                                              ...
                                              print(
                                                  'Marks from this section: ' +
                                                      washingHandsMarks
                                                          .toString());
                                              print(
                                                  'Saving data washingHandsMarks...');
                                              saveToSharedPreferences();
                                              print('Data saved!');
                                              final snackBar = SnackBar(
                                                  content: Text(
                                                      'Congratulations! You have Completed the Washing Hands Section'));
  ...
  void initializeSharedPreferences() async {
    ...
    print('washingHandsCompleted - from SharedPreferences : ' +
        washingHandsCompleted.toString());
    if (washingHandsCompleted != null && washingHandsCompleted) {
      print('Section already completed');
      print('Marks obtained in Washing Hands section: ' +
          washingHandsMarks.toString());
    }
  }
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Column(
        ...
        children: <Widget>[
          Image(
            image: AssetImage('Images/Group-91.png'),
          ),
          SizedBox(height: 30),
          Text(
            context.getString('menu.washingIntro'),
...
class _SurveyCarouselState extends State<SurveyCarousel> {
  ...
  Widget build(BuildContext context) {
    List<SurveyTitle> surveylist = [
      SurveyTitle(context.getString('menu.washing'), 1, '/washing'),
