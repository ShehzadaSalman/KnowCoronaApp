...
class _WashingHandsState extends State<WashingHands> {
 ...
 String apiURL = "https://knowcorona19.com/api/washing";
  ...
  bool washingHandsCompleted = false;
  int correctAttempted = 0;
  double washingHandsMarks = 0.0;
...
//                                               ? color = Color(0xFFF58A97) : color = null;
                                           ...
                                           if(checkAnswer(answerSelected[index], index)){
                                              ...
                                              setState(() {
                                                ...
                                                if(checkAllQuestionsAttempted()){
                                                  ...
                                                  washingHandsMarks = ((correctAttempted/quizHelper.results.length)*(100))*(2/100); // "2" here being the total marks of section
                                                  print('Marks from this section: ' + washingHandsMarks.toString());
                                                  print('Saving data washingHandsMarks...');
                                                  saveToSharedPreferences();
                                                  print('Data saved!');
                                                  final snackBar = SnackBar(content: Text('Congratulations! You have Completed the Washing Hands Section'));
  ...
  void initializeSharedPreferences() async {
    ...
    washingHandsCompleted = sharedPreferences.getBool('washingHandsCompleted');
    washingHandsMarks = sharedPreferences.getDouble('washingHandsMarks');
    print('washingHandsCompleted - from SharedPreferences : ' + washingHandsCompleted.toString());
    if(washingHandsCompleted != null && washingHandsCompleted){
      print('Section already completed');
      print('Marks obtained in Washing Hands section: ' + washingHandsMarks.toString());
    }
  }

  void saveToSharedPreferences() async {
    await sharedPreferences.setBool('washingHandsCompleted', true);
    await sharedPreferences.setDouble('washingHandsMarks', washingHandsMarks);
