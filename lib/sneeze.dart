...
class _SneezeState extends State<Sneeze> {
 ...
 String apiURL = "https://knowcorona19.com/api/sneeze";
  ...
  bool sneezeSectionCompleted = false;
  int correctAttempted = 0;
  double sneezeSectionMarks = 0.0;
...
//                                               ? color = Color(0xFFF58A97) : color = null;
                                            ...
                                            onPressed: (){
                                              ...
                                              setState(() {
                                                ...
                                                if(checkAllQuestionsAttempted()){
                                                  ...
                                                  sneezeSectionMarks = ((correctAttempted/quizHelper.results.length)*(100))*(2/100); // "2" here being the total marks of section
                                                  print('Marks from this section: ' + sneezeSectionMarks.toString());
                                                  print('Saving data sneezeSectionMarks...');
                                                  saveToSharedPreferences();
                                                  print('Data saved!');
                                                  final snackBar = SnackBar(content: Text('Congratulations! You have completed the Sneeze & Cough Section'));
  ...
  void initializeSharedPreferences() async {
    ...
    sneezeSectionCompleted = sharedPreferences.getBool('sneezeSectionCompleted');
    sneezeSectionMarks = sharedPreferences.getDouble('sneezeSectionMarks');
    print('sneezeSectionCompleted - from SharedPreferences : ' + sneezeSectionCompleted.toString());
    if(sneezeSectionCompleted != null && sneezeSectionCompleted){
      print('Section already completed');
      print('Marks obtained in Sneeze section: ' + sneezeSectionMarks.toString());
    }
  }

  void saveToSharedPreferences() async {
    await sharedPreferences.setBool('sneezeSectionCompleted', true);
    await sharedPreferences.setDouble('sneezeSectionMarks', sneezeSectionMarks);
