...
class _SneezeState extends State<Sneeze> {
  String apiURL = "https://knowcorona19.com/api/urduquizsneeze";
...
//                                       children: quizHelper.results[index].incorrectAnswers.map((f){
                                              ...
                                              print(
                                                  'Marks from this section: ' +
                                                      sneezeSectionMarks
                                                          .toString());
                                              print(
                                                  'Saving data sneezeSectionMarks...');
                                              saveToSharedPreferences();
                                              print('Data saved!');
                                              final snackBar = SnackBar(
                                                  content: Text(
                                                      'Congratulations! You have completed the Sneeze & Cough Section'));
  ...
  void initializeSharedPreferences() async {
    ...
    sneezeSectionCompleted =
        sharedPreferences.getBool('sneezeSectionCompleted');
    sneezeSectionMarks = sharedPreferences.getDouble('sneezeSectionMarks');
    print('sneezeSectionCompleted - from SharedPreferences : ' +
        sneezeSectionCompleted.toString());
    if (sneezeSectionCompleted != null && sneezeSectionCompleted) {
      print('Section already completed');
      print(
          'Marks obtained in Sneeze section: ' + sneezeSectionMarks.toString());
    }
  }
...
class _SurveyCarouselState extends State<SurveyCarousel> {
  ...
  Widget build(BuildContext context) {
    List<SurveyTitle> surveylist = [
      SurveyTitle(context.getString('menu.sneeze'), 1, '/sneeze'),
    ...
    return Container(
      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          SizedBox(height: 30),
          Text(
            context.getString('menu.sneezeIntro'),
            textAlign: TextAlign.center,
            style: TextStyle(
              fontSize: 21,
              fontFamily: 'Seg',
